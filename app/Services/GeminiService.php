    ...
    public function generateContent($prompt, $retries = 2)
    {
        ...
        while ($attempt <= $retries) {
            try {
                ...
                if ($statusCode === 429) {
                    return "\n\nThe AI is currently overloaded with requests (Quota Exceeded). Please wait a minute and try again.\n\n_Tip: This usually resets quickly._";
                }
                ...
                if ($e->getCode() === 429 || strpos($e->getMessage(), '429') !== false) {
                    return "Ai Lab is currently overloaded with requests (Quota Exceeded). Please wait a minute and try again.\n\n_Tip: This usually resets quickly._";
                }
